...
ipc_wm_config(uint32_t *d)
{
    ...
    case IPCConfigBorderWidth:
        ...
        if (conf.apply_settings) {
            refresh_borders();
            infoobordersize(conf.border_width);
        }
        break;
    case IPCConfigColorFocused:
        ...
        if (conf.apply_settings) {
            refresh_borders();
            infooborderselcol(conf.focus_color);
        }
        break;
    case IPCConfigColorUnfocused:
        ...
        if (conf.apply_settings) {
            refresh_borders();
            infoobordernormcol(conf.unfocus_color);
        }
        break;
    case IPCConfigInternalBorderWidth:
        ...
        if (conf.apply_settings) {
            refresh_borders();
            infobordersize(conf.internal_border_width);
        }
        break;
    case IPCConfigInternalColorFocused:
        ...
        if (conf.apply_settings) {
            refresh_borders();
            infoborderselcol(conf.internal_focus_color);
        }
        break;
    case IPCConfigInternalColorUnfocused:
        ...
        if (conf.apply_settings) {
            refresh_borders();
            infobordernormcol(conf.internal_unfocus_color);
        }
        break;
